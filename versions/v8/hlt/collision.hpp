...
namespace hlt {
    namespace collision {
                ...
                const double fudge)
        {
			...
			const double center_x = circlePosition.pos_x;
			const double center_y = circlePosition.pos_y;
            ...
            if (a == 0.0) {
                ...
                return start.get_distance_to(circlePosition) <= circle_radius + fudge;
            }
            ...
            const double closest_distance = Location{ closest_x, closest_y }.get_distance_to(circlePosition);
